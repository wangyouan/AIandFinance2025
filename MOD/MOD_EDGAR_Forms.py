"""
    ...
    ND-SRAF / McDonald : 201606 | last update: 202104
    
    Note that sets are used instead of lists for lookup speed
"""

# Tabulate various types of 10-X forms
